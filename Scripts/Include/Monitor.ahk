...
Loop {
    ...
    if(secondsSinceGPTest > 7200 && InGPTestMode == 1){
    ...
    if (runMain && InGPTestMode == 0) {
        ...
        if (LastApproveEpoch > 0) {
            ...
            if (secondsSinceLastApprove > (5 * 60)) {
                LogToFile("Main.ahk appears stuck - no Approve activity for " . secondsSinceLastApprove . " seconds. Restarting...", "Monitor.txt")
